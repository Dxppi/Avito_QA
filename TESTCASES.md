...
**Execution:**
1. Подготовить тело запроса, содержащее **все обязательные поля** (`sellerID`, `name`, `price`, `statistics`) с корректными типами данных.
...
### Тест-кейс 1.6 (Пограничный: Отрицательные значения)
**ID:** TC-C-006
...
**Expected result:**
1. Статус-код **200 OK** или **400 Bad Request** в зависимости от валидации.
...
**Expected result:**
1. Статус-код **200 OK** для DELETE запроса.
...
### Тест-кейс 3.2 (Пограничный: Пустой список)
**ID:** TC-A-002
...
**Expected result:**
1. Статус-код **200 OK** для обоих запросов.
2. Данные статистики в ответах идентичны.

---

### Тест-кейс 6.2 (Пограничный: Большие значения статистики)
**ID:** TC-SV-002
